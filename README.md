...
1. Download [`n-ext-chrome-v0.0.5-alpha.zip`](https://github.com/chaiops/n-ext/releases/download/ext-v0.0.5-alpha/n-ext-chrome-v0.0.5-alpha.zip) or grab the latest from [GitHub Releases](https://github.com/chaiops/n-ext/releases/latest)
